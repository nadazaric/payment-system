...
public class PaymentController {
    ...
    @Operation(
            ...
            description = "Allows PSP to check payment status in bank-payment-plugin when payment callback was not delivered."
    )
    public PspPaymentStatusCheckResponse checkPaymentStatus(
            @Valid @RequestBody PspPaymentStatusCheckRequest request
    ) {
